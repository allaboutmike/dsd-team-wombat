                            ...
                            <table className="min-w-full divide-y divide-zinc-300">
                                <thead>
                                    <tr className="divide-x divide-zinc-200">
                                        ...
                                        <th scope="col" className="px-4 py-3.5 text-left text-sm font-semibold text-zinc-800">Registered by Admin</th>
                                        <th scope="col" className="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-zinc-800 sm:pr-0">Access Type</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-zinc-200 bg-white">
                                    <tr className="divide-x divide-zinc-200">
                                        ...
                                        <td className="whitespace-nowrap p-4 text-sm text-zinc-500">Mike</td>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-teal-500 sm:pr-0">Default</td>
                                    </tr>
                                    ...
                                    <tr className="divide-x divide-zinc-200">
                                        ...
                                        <td className="whitespace-nowrap p-4 text-sm text-zinc-500">Mike</td>
                                        <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-red-400 sm:pr-0">Manual</td>
                                    </tr>
